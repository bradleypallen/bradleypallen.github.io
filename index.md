...
I argue that knowledge engineering is *explicitation*: making the practice of a community of experts explicit, so that it can be reasoned with, evaluated, and answered for. The last of these has been the hard part, and it has stayed constant from the rule-based expert systems of the 1980s to today's large language models: how do we build AI applications such that we can be accountable for their assertions?
